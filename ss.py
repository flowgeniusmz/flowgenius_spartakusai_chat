...
def initialize_session_state():
    if "initialized" not in st.session_state:
        ...
        st.session_state._business_research = ""
        # st.session_state["_buy_insurance"] = ""
        # st.session_state["_insurance_type"] = ""
        # st.session_state["_insurance_reason"] = ""
        # st.session_state["_effective_date"] = ""
        # st.session_state["_business_name"] = ""
